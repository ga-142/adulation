...
namespace Modules\Crawler\Controller;

class AnchorsAway extends \Modules\Crawler\Model\AnchorsAway {

	public function anchorsAway($url, $plunder, $depth = 2)
	{
	    static $seen = array();
	...
	public function plunder($plunder, $resources){
